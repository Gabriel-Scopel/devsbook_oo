    ...
    <div class="box feed-new">
        <div class="box-body">
            <div class="feed-new-editor m-10 row">
                ...
                <div style="cursor: pointer; margin-right: 5px; width:25px;" class="feed-new-photo">
                    <img src="<?= $base; ?>/assets/images/photo.png" />
                    <input style="position: absolute; left: -500px; top:-500px;" type="file" name="photo" class="feed-new-file" accept="image/png, image/jpeg, image/jpg" />
                </div>
